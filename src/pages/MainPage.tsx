  ...
  return (
    <main className="px-6 py-10 max-w-7xl mx-auto">
      <section className="text-center mb-16">
        ...
        <div className="text-lg text-gray-700 space-y-6 max-w-7xl ml-4 text-left leading-relaxed tracking-wide">
          <p>
          ...
          <p>
            We create conditions where it's easy to feel: this is yours.
          </p>
          <p>
            ...
            support, and the level of quality that you want to recommend to
            your friends.
          </p>
          <p>
